...
public class FileUploadTests {
    ...
    public void shouldSaveUploadedFile() throws Exception {
        MockMultipartFile multipartFile = new MockMultipartFile("file", "first.txt", "text/plain", "Spring Framework".getBytes());
    ...
    public void should404WhenMissingFile() throws Exception {
        given(this.storageService.loadAResource("first.txt"))
            .willThrow(StorageFileNotFoundException.class);
        
        this.mvc.perform(get("/files/first.txt")).andExpect(status().isNotFound());
    }
}
